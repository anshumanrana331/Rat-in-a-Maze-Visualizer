...
function Maze() {
  ...
  // Make changes in below matrix elements to get all the paths.
  // Row and Column indices (or indexes) start from 0.
    ...
    <div className={classes.root}>
      <Grid container spacing={1} justify="center"  >
        <Box p={8}>
          ...
          <Grid
            style={{ backgroundColor: "#caf0f8", margin:'5px' }}
            container
            justify="center"
          >
        ...
        <Grid style={{ backgroundColor: "orange", height:"35px", marginTop:"-60px"}} container justify="center">
